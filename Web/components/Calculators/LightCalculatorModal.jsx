...
export function LightCalculatorModal({ onClose }) {
  ...
  const multiplier = type === "Слабке світло" ? 25 : type === "Сильний травник" ? 60 : 40;
  ...
  return (
    <CalculatorModalLayout
      ...
      onClose={onClose}
    >
      <div className="grid grid-cols-[1fr_250px] gap-7 px-7 py-7">
        <div className="space-y-5">
          <CalculatorInput label="Чистий обʼєм акваріума" value={volume} onChange={setVolume} unit="л" />
          ...
          <div>
            ...
            <button
              ...
              className="flex w-full items-center justify-between rounded-2xl border border-slate-300 px-4 py-3 text-base font-bold text-slate-900 transition hover:border-[#FACC15]"
            >
              {type}
        ...
        <ResultPanel color="bg-yellow-400" dark title="Рекомендовано">
          ...
          <p className="mt-2 text-xs text-yellow-900/70">~{multiplier} люмен на 1 літр</p>

          <div className="mt-6 border-t border-yellow-900/10 pt-5">
            <p className="text-sm text-yellow-900/80">Потужність LED-світильника</p>
